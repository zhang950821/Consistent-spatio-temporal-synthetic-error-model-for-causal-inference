# Source chunk: implement all
# Original Rmd lines: 2750-3133
...
# Optional unfinished synthetic-control simulation block from the original Rmd.
# It is disabled by default because the original time index does not match
# time.predictors.prior = 1:100 in this generated simulation panel.
if (isTRUE(getOption("pstsem.run_unfinished_sim_sc", FALSE))) {
